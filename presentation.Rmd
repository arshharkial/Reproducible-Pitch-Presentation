...
3. The GitHub repository containing the R codes required to build the Shiny App (**server.R** and **ui.R**)can be accessed [here](https://github.com/arshharkial/Shiny_Application_and_Reproducible_Pitch.git)
2. The Shiny app can be accessed [here](https://arshharkial.shinyapps.io/shiny_application_and_reproducible_pitch/), which contains
